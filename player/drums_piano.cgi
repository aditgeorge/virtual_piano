...
<body>
    ...
    <div class="tune">
    <form action="drums_piano.cgi" method="post">
...
<div class="instruments" style="margin-bottom:90px;">
    <img src="http://widit.knu.ac.kr/~adit/proj/resources/images/piano.png" style="width:40%;">
    <img src="http://widit.knu.ac.kr/~adit/proj/resources/images/drums.png" style="width:55%;">
</div>
    <div class="drum-keys">
     <kbd id="Z_key"></kbd>
     <kbd id="X_key"></kbd>
...
<script src="Drums_Piano.js"></script>
</body>
</html>
EOP